      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <Users className="w-8 h-8 text-[#F2633A]" />
            <h1 className="text-3xl font-['Archivo'] text-[#212227]">Admin Dashboard</h1>
          </div>
        ...
        <Tabs defaultValue="pending" value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <Card className="rounded-[16px] border-[#E1E0DA]">
              <CardHeader>
                ...
                <CardDescription className="font-['Vazirmatn'] text-[#696A6D]">
                  New wholesale applications awaiting review
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="approved">
            <Card className="rounded-[16px] border-[#E1E0DA]">
              <CardHeader>
                ...
                <CardDescription className="font-['Vazirmatn'] text-[#696A6D]">
                  Active wholesale accounts with approved access
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loadingRegistrations ? (
          ...
          <TabsContent value="quotes">
            <Card className="rounded-[16px] border-[#E1E0DA]">
              <CardHeader>
                ...
                <CardDescription className="font-['Vazirmatn'] text-[#696A6D]">
                  All pricing quotes generated via the calculator
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loadingQuotes ? (
          ...
          <TabsContent value="orders">
            <Card className="rounded-[16px] border-[#E1E0DA]">
              <CardHeader>
                <CardTitle className="font-['Archivo'] text-[#212227] flex items-center gap-2">
                  <FileText className="w-5 h-5 text-[#F2633A]" />
                  Draft Orders
                </CardTitle>
                <CardDescription className="font-['Vazirmatn'] text-[#696A6D]">
                  Pending draft orders awaiting completion
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loadingOrders ? (
            ...
            {selectedRegistration?.status === "approved" && (
              <div className="flex flex-wrap gap-2 w-full">
                {selectedRegistration.shopifyCustomerId && (
                  <a href={`https://admin.shopify.com/store/its-under-it-all/customers/${selectedRegistration.shopifyCustomerId}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#96bf48] hover:bg-[#85aa3d] text-white rounded-[11px] transition-colors font-['Vazirmatn'] text-sm">
                    <ExternalLink className="w-3 h-3" />
                    Shopify Admin
                  </a>
                )}
                {selectedRegistration.clarityAccountId ? (
                  <a href={`https://www.claritycrm.com/accounts/new4.aspx?m=e&id=${selectedRegistration.clarityAccountId}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white rounded-[11px] transition-colors font-['Vazirmatn'] text-sm">
                    <CheckCircle2 className="w-3 h-3" />
                    CRM Synced
                  </a>
                ) : (
